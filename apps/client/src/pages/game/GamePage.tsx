    ...
    return (
        <div className={styles.bossCell}>
                ...
                {showTimer && (
                    <span
                        style={{
                            ...
                            fontSize: "0.75rem",
                            color: timerDanger ? "#ef4444" : "var(--text-dim)",
                            fontWeight: timerDanger ? 700 : 400,
            ...
            <div className={styles.bossHpRow}>
                ...
                <span className={styles.bossHpText}>
                    {boss.hp} / {boss.maxHp}
                </span>
            </div>
...
export function GamePage() {
    ...
    useEffect(() => {
        ...
        const tick = () => {
            const left = Math.max(
                0,
                Math.ceil((game.turnDeadline! - Date.now()) / 1000),
            );
            setTimeLeft(left);
        };
    ...
    const handleSelect = (cardId: string) => {
        ...
        // Мёртвый игрок не может выбирать карты
